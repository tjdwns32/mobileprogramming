...
/**
 * Created by juni0_000 on 2017-12-18.
 */
...
public class MySQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // 테이블 생성하는 코드를 작성한다
        String sql = "create table mytable(id integer primary key autoincrement,position integer, name text, place text, teacher text, color integer, note text);";
        db.execSQL(sql);
    }
